...
This is a script that takes a json export from pinboard (http://pinboard.in) then, using the Linkding  (https://github.com/sissbruecker/linkding/blob/master/docs/API.md), insert them into Linkding (https://github.com/sissbruecker/linkding)
...
4. Copy the example .env.example file as /env 
   ...
   cp .env.example .env
   ```
5. Enter at least PLM_LINKDING_URL and PLM_LINKDING_API_KEY
   ```js
...
This repository contains a script that takes a backup json file from [pinboard](https://pinboard.in) and imports it into [linkding](https://github.com/sissbruecker/linkding)

# Usage
--- Finished importing in 4357.407489538193 seconds --- 
for 2189 records
average 1.99 seconds per link
# Motivation
